...
function xorjson(str){
   ...
   //console.log(tmp);
   var con = "";            //config
   // var tmpcon = "0x000000000000000000000000692a70d2e424a56d2c6c27aa97d1a86395877b3a";
   var tmpcon = "0x000000000000000000000000"+con.substr(2);     //delete "0x"
   console.log(tmpcon);
...
//xorint(53);
//xorsign();
//updateurl("0xb267ff194e1ba09cb16b0502e37cfe785bbf2f0b");

//xorrelate();
//xorint(256);
//xorsign();

// xorjson("helddjfoiassdfjspaodfsfjslkdfjolo");
